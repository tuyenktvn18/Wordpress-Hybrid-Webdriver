package com.wordpress.testCases.admin.browserstack;
...
public class BrowserStack_Post_01_CRUDS extends BaseTest {

    @Parameters({ "browserName", "urlAdmin", "urlUser", "envName", "ipAddress", "portNumber", "osName", "osVersion" })
    @BeforeClass
    public void beforeClass(@Optional("chrome") String browserName, String adminUrl, String endUserUrl, String envName, @Optional("192.168.1.13") String ipAddress, @Optional("4444") String portNumber, @Optional("Windows") String osName, @Optional("10") String osVersion) {
