...
public class BasePage {
    ...
    public String getElementAtribute(WebDriver driver, String locatorType, String atributeName, String... dynamicValues) {
    ...
    @Step("Open end user site with url {1}")
    public UserHomePO openEndUserSite(WebDriver driver, String endUserUrl) {
        openPageUrl(driver, endUserUrl);
        return PageGeneratorManager.getUserHomePage(driver);
    }

    @Step("Open admin site with url {1}")
